...
<body>
    ...
    <form class="container border border-info mt-5 rounded" method="POST" action="./functions/add.patient.php">
        <span class="fs-1">Fill Patient Info:</span>
        ...
        <div class="input-group my-3">
            ...
            <div class="input-group my-3">
                ...
                <input required type="number" name="p-doc" class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Search to assign a doctor...">
